...
--
-- Base de données :  `agudelo-stouvenel_felipe_info1d`
--

DROP DATABASE IF EXISTS agudelo-stouvenel_felipe_info1d;

-- Création d'un nouvelle base de donnée

CREATE DATABASE IF NOT EXISTS agudelo-stouvenel_felipe_info1d;
