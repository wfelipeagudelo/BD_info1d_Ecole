"""
    ...
    Le fichier Config_App.yml doit être correctement paramétré. (host, user, password, nomdevotrebd)
...
try:
    ...
    print(f"Initialisation de la BD Impossible ! (voir DUMP ou Config_App.yml) "
