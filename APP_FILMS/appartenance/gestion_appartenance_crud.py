...
@obj_mon_application.route("/appartenance_afficher/<string:order_by>/<int:id_genre_sel>", methods=['GET', 'POST'])
def appartenance_afficher(order_by, id_genre_sel):
...
def appartenance_update():
    ...
    try:
        ...
        if form_update.validate_on_submit():
            ...
            str_sql_update_intitulegenre = """UPDATE t_appartenance SET appartenance = %(value_personne_genre)s WHERE id_appartenancce = %(value_id_appartenance)s"""
            with MaBaseDeDonnee() as mconn_bd:
