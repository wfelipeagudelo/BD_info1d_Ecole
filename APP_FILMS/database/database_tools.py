"""
    ...
    Nécessite un fichier DUMP en MySql de la BD : /database/agudelo_stouvenel_felipe_info1d.sql
"""
import os
import re
...
class Toolsbd:
    ...
    def test_cmd_CRD_file_dump_sql():
        """
            ...
            Tester si il y a des problèmes éventuels sur le fichier : "agudelo_stouvenel_felipe_info1d.sql"
        ...
        try:
            if os.path.exists(NAME_FILE_DUMP_SQL_BD):
                ...
                lignes_fichier_dump = fichier_dump_sql_bd.read()
                """
                    Si le fichier DUMP en SQL "../database/agudelo_stouvenel_felipe_info1d.sql" existe, 
